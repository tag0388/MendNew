...
let phasingQtyVal = 100;
let remainingQty = phasingQtyVal;
let newPeriodValues = {};

distIds.forEach((pid, idx) => {
    if (idx === distIds.length - 1) {
        newPeriodValues[pid] = Math.round(remainingQty * 10000) / 10000;
    } else {
        const weight = workingDaysInPeriod[pid] / totalWorkingDaysInRange;
...
console.log("Values:", newPeriodValues);
